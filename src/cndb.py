                ...
                if isXP:
                    ...
                    while tmp > 0:
                        ...
                        if old_level < level:
                            ...
                            user.setprop(
                                "rpg_attack", str(atk + random.randint(10, 100))
                            )
                            user.setprop(
                                "rpg_defense", str(defn + random.randint(10, 100))
                            )
                            user.setprop(
                                "rpg_luck", str(luck + random.randint(10, 100))
                            )
                            old_level = level
                        tmp -= 1500 * level
                    ...
                    if isBet:
                        ...
                        if sub:
                            user.setprop(
                                "balance",
                                str(int(float(user.getprop("balance"))) - amount),
                            )
                        else:
                            user.setprop(
                                "balance",
